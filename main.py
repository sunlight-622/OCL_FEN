...
if __name__ == "__main__":
    ...
    ## data args
    parser.add_argument('--use', type = float, default = 1)
    ...
    parser.add_argument('--data_file', default='tinymini40l.pt',help='data file')#mnist_permutations.pt
    parser.add_argument('--noise_level', type = float, default=0.1)
    parser.add_argument('--n_tasks', type=int, default=5)#训练任务数量，默认为-1
    ## model args
    parser.add_argument('--pretrained', type = str, default = 'no')
    parser.add_argument('--con_kl', type = bool, default = False)
    parser.add_argument('--con_klkl', type = bool, default = False)
    ...
    parser.add_argument('--Con_M', type=float, default = 1.0, help='temperature for distilation')
    parser.add_argument('--model', type=str, default='bcl_dual1',
                        help='model to train')
    parser.add_argument('--n_memories', type=int, default=128,
                        help='number of memories per task')#加入记忆数
    parser.add_argument('--memory_strength', default=100, type=float,
    ...
    parser.add_argument('--lr', type=float, default=0.03,
                        help='SGD learning rate')#1e-3
    parser.add_argument('--meta_lr', type=float, default = 1e-3,
                        help='meta lr for MER')
    parser.add_argument('--temperature', type=float, default = 2.0, help='temperature for distilation')
    ...
    parser.add_argument('--n_meta', type=int, default=1)#原来5
    ...
    n_tasks = n_tasks if args.n_tasks <0  else args.n_tasks#可以对任务个数进行选择  -1为30个任务。
    x_tr = x_tr[:n_tasks]
    x_te = x_te[:n_tasks]
    print(n_tasks)
    # model
